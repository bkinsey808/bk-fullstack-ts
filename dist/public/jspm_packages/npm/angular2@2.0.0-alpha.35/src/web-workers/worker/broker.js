...
var MessageBroker = (function() {
  function MessageBroker(_messageBus, _serializer, _zone) {
    ...
    this._messageBus.source.addListener(function(data) {
      return _this._handleMessage(data['data']);
    });
  }
  ...
  MessageBroker = __decorate([di_1.Injectable(), __metadata('design:paramtypes', [Object, serializer_1.Serializer, ng_zone_1.NgZone])], MessageBroker);
